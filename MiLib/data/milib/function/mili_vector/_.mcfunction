...
## 結果を1/10にする
execute as @s run scoreboard players operation @s MK.v.sinTheta /= $10 MK.constants
execute as @s run scoreboard players operation @s MK.v.cosPhi /= $10 MK.constants
execute as @s run scoreboard players operation @s MK.v.sinPhi /= $10 MK.constants
execute as @s run scoreboard players operation @s MK.v.cosTheta /= $10 MK.constants
...
execute as @s[tag=!MK.v.Reverse] store result entity @s Motion[0] double 0.000000001 run scoreboard players get @s MK.v.MotionZ
execute as @s[tag=!MK.v.Reverse] store result entity @s Motion[1] double 0.00001 run scoreboard players get @s MK.v.MotionY
execute as @s[tag=!MK.v.Reverse] store result entity @s Motion[2] double 0.000000001 run scoreboard players get @s MK.v.MotionX

execute as @s[tag=MK.v.Reverse] store result entity @s Motion[2] double 0.000000001 run scoreboard players get @s MK.v.MotionZ
execute as @s[tag=MK.v.Reverse] store result entity @s Motion[1] double 0.00001 run scoreboard players get @s MK.v.MotionY
execute as @s[tag=MK.v.Reverse] store result entity @s Motion[0] double 0.000000001 run scoreboard players get @s MK.v.MotionX
