# tickが0だったら、AI削除/NoGravity付与/ポジション変更/穴あき場所の抽選/スキル表示を行う
...
# 120tickで効果音
execute if score $mistcrestLakeBoss.miraculousSwordDance Boss.Tick matches 1120 run function boss:section/first/mistcrest_lake/miraculous_sword_dance/boss_instance/action_func/skills/sword_dance/sound
# 120tickで武器を飛ばし始める
