...
#ボスバーを修正(最大HPを加算)
execute store result bossbar boss:story/mistcrestlake.miraculous_sword_dance max run scoreboard players operation @s Mobs.Health.Max += @s Boss.Health.LoadPlus
