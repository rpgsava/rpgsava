...
data merge entity @s {IsBaby:False,CustomNameVisible:True,Tags:["mistcrestLakeBoss.miraculousSwordDance","mistcrestLakeBoss.miraculousSwordDance.Enemy","mistcrestLakeBoss","mistcrestLakeEnemy","sectionFirstEnemy","Enemy","Boss","section/first/mistcrest_lake/miraculous_sword_dance"]}
