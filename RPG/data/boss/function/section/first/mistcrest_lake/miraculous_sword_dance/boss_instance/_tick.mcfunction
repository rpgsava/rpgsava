...
# 乱数が1なら
execute if score $skill_rand Boss.mistcrestLakeBoss.miraculousSwordDance matches 1..2 if score $mistcrestLakeBoss.miraculousSwordDance Boss.Tick matches 1000..1399 run function boss:section/first/mistcrest_lake/miraculous_sword_dance/boss_instance/action_func/skills/embers_of_flame/_
# 乱数が2なら
