...
scoreboard players set $49 Core.Int 49
...
data merge storage core:shop {init:{Items:[{Slot:0b,count:1b,id:"minecraft:black_stained_glass_pane",components: {"minecraft:custom_data": {ShopItem:true}}},{Slot:1b,count:1b,id:"minecraft:black_stained_glass_pane",components: {"minecraft:custom_data": {ShopItem:true}}},{Slot:2b,count:1b,id:"minecraft:black_stained_glass_pane",components: {"minecraft:custom_data": {ShopItem:true}}},{Slot:3b,count:1b,id:"minecraft:black_stained_glass_pane",components: {"minecraft:custom_data": {ShopItem:true}}},{Slot:4b,count:1b,id:"minecraft:black_stained_glass_pane",components: {"minecraft:custom_data": {ShopItem:true}}},{Slot:5b,count:1b,id:"minecraft:black_stained_glass_pane",components: {"minecraft:custom_data": {ShopItem:true}}},{Slot:6b,count:1b,id:"minecraft:black_stained_glass_pane",components: {"minecraft:custom_data": {ShopItem:true}}},{Slot:7b,count:1b,id:"minecraft:black_stained_glass_pane",components: {"minecraft:custom_data": {ShopItem:true}}},{Slot:8b,count:1b,id:"minecraft:black_stained_glass_pane",components: {"minecraft:custom_data": {ShopItem:true}}},{Slot:10b,count:1b,id:"minecraft:wooden_sword",components: {"minecraft:custom_data": {ShopItem:true},display:{Name:'[{"translate":"RPG.Shop.Weapon","color":"yellow"}]'},HideFlags:255}},{Slot:11b,count:1b,id:"minecraft:leather_chestplate",components: {"minecraft:custom_data": {ShopItem:true},display:{Name:'[{"translate":"RPG.Shop.Armor","color":"yellow"}]'},HideFlags:255}},{Slot:12b,count:1b,id:"minecraft:glow_berries",components: {"minecraft:custom_data": {ShopItem:true},display:{Name:'[{"translate":"RPG.Shop.Fruit","color":"yellow"}]'},HideFlags:255}},{Slot:13b,count:1b,id:"minecraft:emerald",components: {"minecraft:custom_data": {ShopItem:true},display:{Name:'[{"translate":"RPG.Shop.Other","color":"yellow"}]'},HideFlags:255}},{Slot:18b,count:1b,id:"minecraft:black_stained_glass_pane",components: {"minecraft:custom_data": {ShopItem:true}}},{Slot:19b,count:1b,id:"minecraft:black_stained_glass_pane",components: {"minecraft:custom_data": {ShopItem:true}}},{Slot:20b,count:1b,id:"minecraft:black_stained_glass_pane",components: {"minecraft:custom_data": {ShopItem:true}}},{Slot:21b,count:1b,id:"minecraft:black_stained_glass_pane",components: {"minecraft:custom_data": {ShopItem:true}}},{Slot:22b,count:1b,id:"minecraft:black_stained_glass_pane",components: {"minecraft:custom_data": {ShopItem:true}}},{Slot:23b,count:1b,id:"minecraft:black_stained_glass_pane",components: {"minecraft:custom_data": {ShopItem:true}}},{Slot:24b,count:1b,id:"minecraft:black_stained_glass_pane",components: {"minecraft:custom_data": {ShopItem:true}}},{Slot:25b,count:1b,id:"minecraft:black_stained_glass_pane",components: {"minecraft:custom_data": {ShopItem:true}}},{Slot:26b,count:1b,id:"minecraft:black_stained_glass_pane",components: {"minecraft:custom_data": {ShopItem:true}}}]}}
