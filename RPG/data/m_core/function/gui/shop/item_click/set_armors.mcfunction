...
# 防具のセット
execute on passengers run data modify entity @s[tag=Shop.Minecart.SetItemNow] Items set from entity @s Passengers[0].data.Armors
# 戻るボタンのセット
...
tag @s add Minecart.Shop.ArmorDisplay
