...
execute if data storage core:shop exist.10 unless data entity @s Items[{Slot:10b}] on passengers run data modify block 0 0 0 Items[] set from entity @s data.Weapons[{Slot:10b}]
execute if data storage core:shop exist.11 unless data entity @s Items[{Slot:11b}] on passengers run data modify block 0 0 0 Items[] set from entity @s data.Weapons[{Slot:11b}]
execute if data storage core:shop exist.12 unless data entity @s Items[{Slot:12b}] on passengers run data modify block 0 0 0 Items[] set from entity @s data.Weapons[{Slot:12b}]
execute if data storage core:shop exist.13 unless data entity @s Items[{Slot:13b}] on passengers run data modify block 0 0 0 Items[] set from entity @s data.Weapons[{Slot:13b}]
execute if data storage core:shop exist.14 unless data entity @s Items[{Slot:14b}] on passengers run data modify block 0 0 0 Items[] set from entity @s data.Weapons[{Slot:14b}]
execute if data storage core:shop exist.15 unless data entity @s Items[{Slot:15b}] on passengers run data modify block 0 0 0 Items[] set from entity @s data.Weapons[{Slot:15b}]
