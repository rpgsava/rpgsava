...
# どこが元々あってどこがなくなったかを検知する
    ...
    execute on passengers run data modify storage core:shop exist.10 set from entity @s data.Armors[{Slot:10b}]
    execute on passengers run data modify storage core:shop exist.11 set from entity @s data.Armors[{Slot:11b}]
    execute on passengers run data modify storage core:shop exist.12 set from entity @s data.Armors[{Slot:12b}]
    execute on passengers run data modify storage core:shop exist.13 set from entity @s data.Armors[{Slot:13b}]
    execute on passengers run data modify storage core:shop exist.14 set from entity @s data.Armors[{Slot:14b}]
    execute on passengers run data modify storage core:shop exist.15 set from entity @s data.Armors[{Slot:15b}]
...
execute if data storage core:shop exist.10 unless data entity @s Items[{Slot:10b}] run execute on passengers run data modify block 0 0 0 Items[] set from entity @s data.Armors[{Slot:10b}]
execute if data storage core:shop exist.11 unless data entity @s Items[{Slot:11b}] run execute on passengers run data modify block 0 0 0 Items[] set from entity @s data.Armors[{Slot:11b}]
execute if data storage core:shop exist.12 unless data entity @s Items[{Slot:12b}] run execute on passengers run data modify block 0 0 0 Items[] set from entity @s data.Armors[{Slot:12b}]
execute if data storage core:shop exist.13 unless data entity @s Items[{Slot:13b}] run execute on passengers run data modify block 0 0 0 Items[] set from entity @s data.Armors[{Slot:13b}]
execute if data storage core:shop exist.14 unless data entity @s Items[{Slot:14b}] run execute on passengers run data modify block 0 0 0 Items[] set from entity @s data.Armors[{Slot:14b}]
execute if data storage core:shop exist.15 unless data entity @s Items[{Slot:15b}] run execute on passengers run data modify block 0 0 0 Items[] set from entity @s data.Armors[{Slot:15b}]

data modify block 0 0 0 Items[0].Slot set value 0b

# アイテムを戻す
tag @s add Shop.Minecart.SetItemNow
function m_core:gui/shop/item_click/set_armors
