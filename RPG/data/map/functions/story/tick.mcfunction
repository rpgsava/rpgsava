...
execute as @a[tag=Story.FirstPlains] at @s run function map:story/first_plain/tick
execute as @a[tag=Story.ValleyOfSpringBreeze] at @s run function map:story/valley_of_spring_breeze/tick
