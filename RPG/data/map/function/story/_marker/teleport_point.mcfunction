...
data merge entity @s {item:{id:"minecraft:barrier",count:1b},billboard:"vertical",brightness:{block:15,sky:15},shadow_radius:0,Glowing:true,glow_color_override:1090560,view_range:0.25}
