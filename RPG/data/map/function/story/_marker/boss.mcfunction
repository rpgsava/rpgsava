...
data merge entity @s {item:{id:"minecraft:red_dye",count:1b},billboard:"vertical",brightness:{block:15,sky:15},shadow_radius:0,Glowing:true,glow_color_override:13107200,view_range:0.25}
